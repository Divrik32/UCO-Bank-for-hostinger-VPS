...
export default function UserLayout() {
  ...
  const memberHeaderStyle = (hovered) => ({
    display: "flex",
    alignItems: "center",
    gap: "10px",
    padding: "9px 20px",
            ...
            <div style={{ position: "relative", flexShrink: 0 }}>
              <div style={{
                ...
                <img
                  ...
                  onError={(e) => { e.target.onerror = null; e.target.src = "/assets/default-user.png"; }}
                />
              </div>
              {/* Online dot */}
              <span style={{
            ...
            {!isMobile && (
              <div style={{
                ...
                <span style={{
                  ...
                  <i className="bi bi-person-fill" style={{ fontSize: "9px" }}></i>
                  Member
                </span>
              </div>
            )}
          ...
          {showProfileMenu && (
            <div style={{
              ...
              <div style={{
                ...
                <i className="bi bi-person-fill" style={{ color: "#fff", fontSize: "12px" }}></i>
        ...
        <ul style={{
          ...
          <li>
            <div
              ...
              onMouseLeave={() => setHoveredNav(null)}
              style={memberHeaderStyle(hoveredNav === "member")}
            >
            ...
            <div style={{
              maxHeight: memberOpen ? "300px" : "0",
              overflow: "hidden",
              transition: "max-height 0.25s ease",
            }}>
              <ul style={{ listStyle: "none", padding: "2px 4px", margin: 0 }}>
                {[
                  { path: "/user/pi1",  label: "Personal Information" },
                  { path: "/user/mgi2", label: "KYC Form" },
                  { path: "/user/mbi3", label: "Member Banking Information" },
                  { path: "/user/ni4",  label: "Nominee Form" },
                  { path: "/user/edit", label: "Edit Your Details" },
                ].map(({ path, label }) => (
                  <li key={path}>
                    <Link
                      to={path}
          ...
          {/* Other nav links */}
          {[
            { path: "/user/thrift",  label: "Thrift Funds",  icon: "bi-piggy-bank" },
            { path: "/user/share",   label: "Shares",        icon: "bi-bar-chart-line" },
            { path: "/user/loan",    label: "Loan",          icon: "bi-cash-stack" },
            { path: "/user/report",  label: "Reports",       icon: "bi-file-earmark-bar-graph" },
          ].map(({ path, label, icon }) => (
            <li key={path}>
              <Link
                to={path}
