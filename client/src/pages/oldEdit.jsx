...
function UploadBox({ label, preview, required = false }) {
  return (
    <div style={{
      ...
      <p>{label} {required && <span style={{ color: "red" }}>*</span>}</p>
...
const handleDone = async () => {
  ...
  if (
    ...
    // images
    if (existingFiles.profile_image) {
      submitData.append("profile_image", existingFiles.profile_image);
    }
    if (existingFiles.signature_image) {
      submitData.append("signature_image", existingFiles.signature_image);
    }
    if (existingFiles.doc1File) {
      submitData.append("doc1File", existingFiles.doc1File);
    }
    if (existingFiles.doc2File) {
      submitData.append("doc2File", existingFiles.doc2File);
    }
    ...
    <div style={{ fontFamily: "'Open Sans', sans-serif" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
        ...
        <div>
          ...
          {/* Personal Info — disabled/read-only */}
      ...
      {showModal && (
        ...
        >
          ...
          >
            ...
            >
              <h5 style={{ fontSize: 16, fontWeight: 600, color: "#012970", margin: 0 }}>
